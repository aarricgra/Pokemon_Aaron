...
public class PokeAPI {
    ...
    ArrayList<Pokemon> getPokemonsName() {
        AsyncTask<Void, Void, ArrayList<Pokemon>> asyncTask = new AsyncTask<Void, Void, ArrayList<Pokemon>>() {
            @Override
        ...
        try {
            return asyncTask.execute().get(); // Espera a que la tarea asincrónica termine y devuelve el resultado
